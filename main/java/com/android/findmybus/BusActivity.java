...
public class BusActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recyclerView_busActivity);

        if (isConnected()) {
            new BusActivity.prepareJson().execute();
            Log.e("connection", "Internet Connected!...");
        }
        else {
            AlertDialog.Builder alertDialog = new AlertDialog.Builder(BusActivity.this);
    ...
    private boolean isConnected() {
        ConnectivityManager manager = (ConnectivityManager) BusActivity.this.getSystemService(Context.CONNECTIVITY_SERVICE);
