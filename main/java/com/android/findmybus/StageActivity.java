...
public class StageActivity extends AppCompatActivity {
    ...
    ArrayList<StageModel> list = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recyclerView_stageActivity);

        if (isConnected()) {
            new StageActivity.prepareJson().execute();
    ...
    private boolean isConnected() {
        ConnectivityManager manager = (ConnectivityManager) StageActivity.this.getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    private class prepareJson extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(StageActivity.this);
    ...
    private void prepareBusList() {
        StageAdapter adapter = new StageAdapter(list, this);
